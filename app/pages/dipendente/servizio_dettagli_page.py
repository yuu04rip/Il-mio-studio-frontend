...
def servizio_dettagli_page(id: str = None):
    ...
    # Se usi route /servizio_dettagli/{id}
    servizio_id = id

    # Se usi query string: /servizio_dettagli?id=123
    ...
    with ui.card().classes('q-pa-xl q-mt-xl q-mx-auto').style('max-width: 800px;'):
        ...
        try:
            ...
            # Recupera informazioni aggiuntive dal nuovo endpoint DETTAGLIATO!
        ...
        # Sezione cliente (usa la chiamata ai dettagli estesi!)
        ...
        # Sezione dipendente che ha inizializzato il servizio
        with ui.card().classes('q-pa-md q-mb-md').style('background:#e3f2fd;'):
            ...
            try:
                ...
                if dipendenti_resp.status_code == 200:
                    ...
                    if dipendenti:
                        # Supponiamo che il primo sia quello che ha inizializzato il servizio
...
def get_icon_for_stato(stato):
    """Funzione helper per le icone dello stato (copiata dalla pagina principale)"""
    icons = {
